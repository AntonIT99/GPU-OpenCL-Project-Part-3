...
bool CAssignment3::DoCompute()
{
	...
	{
		//size of the tile in pixels proccessed by a single work-gorup
		...
		*/
		...
		//true stands for gray scale
		//0.0f is the constant offset added to each pixel after the convolution
	...
	//We did not have this part in the Assignment
	/*cout<<endl<<"########################################"<<endl;
	...
	cout<<endl<<"########################################"<<endl;
	cout<<"Task 3: Histogram"<<endl<<endl;
	{
